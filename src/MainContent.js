...
const MainContent = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://mynode.trucksbooking.in/table1?feildcrn=${feildcrn}`)
      .then((response) => {
    ...
    axios.get(`https://mynode.trucksbooking.in/table2?feildcrn=${feildcrn}`)
      .then((response) => {
    ...
    axios.get(`https://mynode.trucksbooking.in/table3?feildcrn=${feildcrn}`)
      .then((response) => {
